...
class InstagramSpider(scrapy.Spider):
    ...
    instagram_login = 'Onliskill_udm'
    instagram_password = '#PWD_INSTAGRAM_BROWSER:10:1629134401:AZNQADhpc+bWhQPCHdPnnMtqDwG3EqFtVbBaoTVpGji/FtQCcRL+OG5LQjtX2tpvK4as5MaBWcHvKIrR9E4snPyMHR0shBNIXyMEGqMPhd/XLfmIZHQGiu/ZHrCSPJOTPY3dMURUroMRkcH8xBs='
    ...
    def login(self, response: HtmlResponse):
        ...
        if j_data['authenticated']:
            yield response.follow(f'/{self.user_parse}', callback=self.user_parsing, cb_kwargs={'username': self.user_parse})
